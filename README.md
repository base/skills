...
| Skill | Description |
| ----- | ----------- |
| [Account Policies](./skills/account-policies/SKILL.md) | Designs account policies for gas sponsorship allowlists, spend permission guardrails, subscription templates, and scenario-based validation for Base Account integrations. |
