...
| [Benchmarking on OP Stack](./skills/benchmarking-on-op-stack/SKILL.md) | Teaches disciplined benchmarking methodology for Base and OP Stack chains. Covers apples-to-apples comparisons, warmup runs, four measurement domains (RPC latency, transaction lifecycle, log queries, gas), environment tiers, fair comparison rules, and common mistakes. |
