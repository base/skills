...
- the protocol/entity is solely responsible for the plugin, and submitting a plugin is subject to the [applicable terms of service](https://wallet.coinbase.com/terms-of-service) as using a "Service"; and
